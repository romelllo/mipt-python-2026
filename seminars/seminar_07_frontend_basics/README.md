...
Перейдите к файлу [`exercises/frontend_practice.md`](exercises/frontend_practice.md) и выполните **Часть 1: HTML-структура** (задания 1.1–1.2).
...
Перейдите к файлу [`exercises/frontend_practice.md`](exercises/frontend_practice.md) и выполните **Часть 2: CSS-стилизация** (задания 2.1–2.3).
...
Перейдите к файлу [`exercises/frontend_practice.md`](exercises/frontend_practice.md) и выполните **Часть 3: JavaScript — основы** (задания 3.1–3.2).
...
Перейдите к файлу [`exercises/frontend_practice.md`](exercises/frontend_practice.md) и выполните **Часть 4: Django Templates** (задания 4.1–4.3).
...
Перейдите к файлу [`exercises/frontend_practice.md`](exercises/frontend_practice.md) и выполните **Часть 5: Собираем всё вместе** (задания 5.1–5.2).
